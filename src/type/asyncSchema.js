...
export function isSchema(schema) {
  return instanceOf(schema, AsyncGraphQLSchema);
}

export function assertSchema(schema: mixed): AsyncGraphQLSchema {
  if (!isSchema(schema)) {
 ...
 *
 */
export class AsyncGraphQLSchema {
...
defineToStringTag(AsyncGraphQLSchema);
